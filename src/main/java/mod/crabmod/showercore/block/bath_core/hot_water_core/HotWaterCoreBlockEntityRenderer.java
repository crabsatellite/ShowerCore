...
@OnlyIn(Dist.CLIENT)
public class HotWaterCoreBlockEntityRenderer implements BlockEntityRenderer<HotWaterCoreBlockEntity>{

    public static final Material SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/hot_water_core_base"));
    public static final Material ACTIVE_SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/hot_water_core_cage"));
    public static final Material WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/hot_water_core_wind"));
    public static final Material VERTICAL_WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/hot_water_core_wind_vertical"));
    public static final Material OPEN_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/hot_water_core_open"));
    public static final Material CLOSED_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/hot_water_core_closed"));
    ...
    public HotWaterCoreBlockEntityRenderer(BlockEntityRendererProvider.Context pContext) {
        this.renderer = pContext.getBlockEntityRenderDispatcher();
        this.eye = pContext.bakeLayer(HotWaterCoreModelLayers.HOT_WATER_CORE_EYE);
        this.wind = pContext.bakeLayer(HotWaterCoreModelLayers.HOT_WATER_CORE_WIND);
        this.shell = pContext.bakeLayer(HotWaterCoreModelLayers.HOT_WATER_CORE_SHELL);
        this.cage = pContext.bakeLayer(HotWaterCoreModelLayers.HOT_WATER_CORE_CAGE);
    }
    ...
    @Override
    public void render(HotWaterCoreBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
