...
public class MilkBathCoreModelLayers {
  public static final ModelLayerLocation MILK_BATH_CORE_CAGE =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "milk_bath_core/cage"), "main");

  public static final ModelLayerLocation MILK_BATH_CORE_SHELL =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "milk_bath_core/shell"), "main");

  public static final ModelLayerLocation MILK_BATH_CORE_EYE =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "milk_bath_core/eye"), "main");

  public static final ModelLayerLocation MILK_BATH_CORE_WIND =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "milk_bath_core/wind"), "main");
}
