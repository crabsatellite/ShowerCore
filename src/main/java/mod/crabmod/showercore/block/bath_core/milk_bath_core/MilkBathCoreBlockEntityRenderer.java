...
public class MilkBathCoreBlockEntityRenderer implements BlockEntityRenderer<MilkBathCoreBlockEntity>{
    ...
    public MilkBathCoreBlockEntityRenderer(BlockEntityRendererProvider.Context pContext) {
        this.renderer = pContext.getBlockEntityRenderDispatcher();
        this.eye = pContext.bakeLayer(MilkBathCoreModelLayers.MILK_BATH_CORE_EYE);
        this.wind = pContext.bakeLayer(MilkBathCoreModelLayers.MILK_BATH_CORE_WIND);
        this.shell = pContext.bakeLayer(MilkBathCoreModelLayers.MILK_BATH_CORE_SHELL);
        this.cage = pContext.bakeLayer(MilkBathCoreModelLayers.MILK_BATH_CORE_CAGE);
    }
    ...
    @Override
    public void render(MilkBathCoreBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
