...
public class MilkBathCoreBlockEntity extends BlockEntity {
  ...
  public MilkBathCoreBlockEntity(BlockPos pPos, BlockState pBlockState) {
    super(BlockEntitiesRegister.MILK_BATH_CORE_BLOCK_ENTITY.get(), pPos, pBlockState);
  }
  ...
  public static void clientTick(
      Level pLevel, BlockPos pPos, BlockState pState, MilkBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateHunting(
          MilkBathCoreBlockEntity pBlockEntity, List<BlockPos> pPositions) {
  ...
  private static boolean isBathCoreFrame(
    ...
    for (Block block : Config.milkBathCoreBlocks) {
  ...
  private static void updateDestroyTarget(
      ...
      MilkBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateClientTarget(
      Level pLevel, BlockPos pPos, MilkBathCoreBlockEntity pBlockEntity) {
