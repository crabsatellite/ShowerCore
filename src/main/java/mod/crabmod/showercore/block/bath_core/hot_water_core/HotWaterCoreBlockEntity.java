...
public class HotWaterCoreBlockEntity extends BlockEntity {
  ...
  public HotWaterCoreBlockEntity(BlockPos pPos, BlockState pBlockState) {
    super(BlockEntitiesRegister.HOT_WATER_CORE_BLOCK_ENTITY.get(), pPos, pBlockState);
  }
  ...
  public static void clientTick(
      Level pLevel, BlockPos pPos, BlockState pState, HotWaterCoreBlockEntity pBlockEntity) {
  ...
  private static void updateHunting(
      HotWaterCoreBlockEntity pBlockEntity, List<BlockPos> pPositions) {
  ...
  private static boolean isBathCoreFrame(
    ...
    for (Block block : Config.hotWaterCoreBlocks) {
  ...
  private static void updateDestroyTarget(
      ...
      HotWaterCoreBlockEntity pBlockEntity) {
  ...
  private static void updateClientTarget(
      Level pLevel, BlockPos pPos, HotWaterCoreBlockEntity pBlockEntity) {
