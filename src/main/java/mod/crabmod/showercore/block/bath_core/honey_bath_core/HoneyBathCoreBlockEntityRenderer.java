...
@OnlyIn(Dist.CLIENT)
public class HoneyBathCoreBlockEntityRenderer implements BlockEntityRenderer<HoneyBathCoreBlockEntity>{

    public static final Material SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/honey_bath_core_base"));
    public static final Material ACTIVE_SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/honey_bath_core_cage"));
    public static final Material WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/honey_bath_core_wind"));
    public static final Material VERTICAL_WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/honey_bath_core_wind_vertical"));
    public static final Material OPEN_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/honey_bath_core_open"));
    public static final Material CLOSED_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/honey_bath_core_closed"));
    ...
    public HoneyBathCoreBlockEntityRenderer(BlockEntityRendererProvider.Context pContext) {
        this.renderer = pContext.getBlockEntityRenderDispatcher();
        this.eye = pContext.bakeLayer(HoneyBathCoreModelLayers.HONEY_BATH_CORE_EYE);
        this.wind = pContext.bakeLayer(HoneyBathCoreModelLayers.HONEY_BATH_CORE_WIND);
        this.shell = pContext.bakeLayer(HoneyBathCoreModelLayers.HONEY_BATH_CORE_SHELL);
        this.cage = pContext.bakeLayer(HoneyBathCoreModelLayers.HONEY_BATH_CORE_CAGE);
    }
    ...
    @Override
    public void render(HoneyBathCoreBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
