...
public class PeonyBathCoreBlockEntityRenderer implements BlockEntityRenderer<PeonyBathCoreBlockEntity>{
    ...
    public static final Material SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(ShowerCore.MODID, "entity/conduit/peony_bath_core_base"));
    public static final Material ACTIVE_SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(ShowerCore.MODID, "entity/conduit/peony_bath_core_cage"));
    public static final Material WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(ShowerCore.MODID, "entity/conduit/peony_bath_core_wind"));
    public static final Material VERTICAL_WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(ShowerCore.MODID, "entity/conduit/peony_bath_core_wind_vertical"));
    public static final Material OPEN_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(ShowerCore.MODID, "entity/conduit/peony_bath_core_open"));
    public static final Material CLOSED_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, new ResourceLocation(ShowerCore.MODID, "entity/conduit/peony_bath_core_closed"));
