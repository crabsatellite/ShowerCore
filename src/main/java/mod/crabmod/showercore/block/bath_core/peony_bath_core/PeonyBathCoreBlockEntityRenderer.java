package mod.crabmod.showercore.block.bath_core.peony_bath_core;
...
@OnlyIn(Dist.CLIENT)
public class PeonyBathCoreBlockEntityRenderer implements BlockEntityRenderer<PeonyBathCoreBlockEntity>{

    public static final Material SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/peony_bath_core_base"));
    public static final Material ACTIVE_SHELL_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/peony_bath_core_cage"));
    public static final Material WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/peony_bath_core_wind"));
    public static final Material VERTICAL_WIND_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/peony_bath_core_wind_vertical"));
    public static final Material OPEN_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/peony_bath_core_open"));
    public static final Material CLOSED_EYE_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "entity/conduit/peony_bath_core_closed"));
    ...
    public PeonyBathCoreBlockEntityRenderer(BlockEntityRendererProvider.Context pContext) {
        this.renderer = pContext.getBlockEntityRenderDispatcher();
        this.eye = pContext.bakeLayer(PeonyBathCoreModelLayers.PEONY_BATH_CORE_EYE);
        this.wind = pContext.bakeLayer(PeonyBathCoreModelLayers.PEONY_BATH_CORE_WIND);
        this.shell = pContext.bakeLayer(PeonyBathCoreModelLayers.PEONY_BATH_CORE_SHELL);
        this.cage = pContext.bakeLayer(PeonyBathCoreModelLayers.PEONY_BATH_CORE_CAGE);
    }
    ...
    @Override
    public void render(PeonyBathCoreBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
