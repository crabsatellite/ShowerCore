...
public class PeonyBathCoreBlockEntity extends BlockEntity {
  ...
  public PeonyBathCoreBlockEntity(BlockPos pPos, BlockState pBlockState) {
  ...
  public static void clientTick(
      Level pLevel, BlockPos pPos, BlockState pState, PeonyBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateHunting(
          PeonyBathCoreBlockEntity pBlockEntity, List<BlockPos> pPositions) {
  ...
  private static boolean isBathCoreFrame(
    ...
    for (Block block : Config.peonyBathCoreBlocks) {
    ...
    if (!list.isEmpty()) {
      for (Player player : list) {
        if (pPos.closerThan(player.blockPosition(), (double) j)) {
          player.addEffect(new MobEffectInstance(MobEffects.LUCK, 260, 1, false, false));
        }
      }
    }
  }
  ...
  private static void updateDestroyTarget(
      ...
      PeonyBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateClientTarget(
      Level pLevel, BlockPos pPos, PeonyBathCoreBlockEntity pBlockEntity) {
