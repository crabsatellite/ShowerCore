...
public class HerbalBathCoreModelLayers {
  public static final ModelLayerLocation HERBAL_BATH_CORE_CAGE =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "herbal_bath_core/cage"), "main");

  public static final ModelLayerLocation HERBAL_BATH_CORE_SHELL =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "herbal_bath_core/shell"), "main");

  public static final ModelLayerLocation HERBAL_BATH_CORE_EYE =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "herbal_bath_core/eye"), "main");

  public static final ModelLayerLocation HERBAL_BATH_CORE_WIND =
      new ModelLayerLocation(
          ResourceLocation.fromNamespaceAndPath(ShowerCore.MODID, "herbal_bath_core/wind"), "main");
}
