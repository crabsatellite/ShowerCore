...
public class HoneyBathCoreBlockEntity extends BlockEntity {
  ...
  public HoneyBathCoreBlockEntity(BlockPos pPos, BlockState pBlockState) {
    super(BlockEntitiesRegister.HONEY_BATH_CORE_BLOCK_ENTITY.get(), pPos, pBlockState);
  }
  ...
  public static void clientTick(
      Level pLevel, BlockPos pPos, BlockState pState, HoneyBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateHunting(
          HoneyBathCoreBlockEntity pBlockEntity, List<BlockPos> pPositions) {
  ...
  private static boolean isBathCoreFrame(
    ...
    for (Block block : Config.honeyBathCoreBlocks) {
  ...
  private static void updateDestroyTarget(
      ...
      HoneyBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateClientTarget(
      Level pLevel, BlockPos pPos, HoneyBathCoreBlockEntity pBlockEntity) {
