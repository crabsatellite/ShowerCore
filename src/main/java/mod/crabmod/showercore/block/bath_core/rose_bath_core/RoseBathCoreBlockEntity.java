...
public class RoseBathCoreBlockEntity extends BlockEntity {
  ...
  public RoseBathCoreBlockEntity(BlockPos pPos, BlockState pBlockState) {
    super(BlockEntitiesRegister.ROSE_BATH_CORE_BLOCK_ENTITY.get(), pPos, pBlockState);
  }
  ...
  public static void clientTick(
      Level pLevel, BlockPos pPos, BlockState pState, RoseBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateHunting(
          RoseBathCoreBlockEntity pBlockEntity, List<BlockPos> pPositions) {
    ...
    if (!list.isEmpty()) {
      for (Player player : list) {
        if (pPos.closerThan(player.blockPosition(), (double) j)) {
          player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 260, 1, false, false));
        }
      }
    }
  }
  ...
  private static void updateDestroyTarget(
      ...
      RoseBathCoreBlockEntity pBlockEntity) {
  ...
  private static void updateClientTarget(
      Level pLevel, BlockPos pPos, RoseBathCoreBlockEntity pBlockEntity) {
