...
public class ShowerCore {
  ...
  private void addShowerCoreItems(BuildCreativeModeTabContentsEvent event) {
      ...
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_WHITE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_ORANGE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_MAGENTA.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_LIGHT_BLUE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_YELLOW.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_LIME.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_PINK.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_GRAY.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_LIGHT_GRAY.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_CYAN.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_PURPLE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_BLUE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_BROWN.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_GREEN.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_RED.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_BLACK.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_OAK.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_SPRUCE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_BIRCH.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_JUNGLE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_ACACIA.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_DARK_OAK.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_MANGROVE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_CHERRY.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_BAMBOO.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_CRIMSON.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_WARPED.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_STONE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_COBBLESTONE.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_IRON.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_GOLD.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_COPPER.get());
      event.accept(BlocksRegister.BATHTUB_CLAWFOOT_DIAMOND.get());
